      ...
      <div class="login-card card-glass">
        ...
        <div class="login-header">
          <div class="login-logo">
            <img src="/favicon.svg" alt="ResultLog Logo" width="80" height="80" />
          </div>
          <h1 class="login-title">ResultLog</h1>
          <p class="login-subtitle">
            Googleカレンダーと連携して<br />収支を簡単に記録・分析
          </p>
        </div>
        ...
        <div class="login-features">
          <div class="feature-item">
            <i class="feature-icon fa-solid fa-pen-to-square"></i>
            <span class="feature-text">かんたん収支登録</span>
          </div>
          <div class="feature-item">
            <i class="feature-icon fa-solid fa-chart-line"></i>
            <span class="feature-text">店舗・機種・曜日別集計</span>
          </div>
          <div class="feature-item">
            <i class="feature-icon fa-solid fa-chart-area"></i>
